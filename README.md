...
활성 내부 직원은 화면 우측의 **의견 보내기**에서 오류·개선 제안·문의·기타 의견을 남길 수 있습니다. 의견에는 현재 경로, 제한된 화면 이름, 관련 설문 ID만 자동 기록하며 주민 개인정보나 응답 원문은 자동 첨부하지 않습니다. 본인 의견은 `/feedback`에서, 전체 의견의 상태 관리는 admin/super_admin의 `/admin/feedback`에서 수행합니다.
