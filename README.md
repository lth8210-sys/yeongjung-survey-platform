...
향후 설문별 결과 공유를 위한 `staff_directory`는 직원 선택용 최소 projection(uid, 이름, 활성 여부)입니다. users 원본 read 권한이나 Viewer 결과 접근은 아직 확대하지 않으며, 기존 직원 directory backfill은 별도 운영 승인이 필요합니다.
