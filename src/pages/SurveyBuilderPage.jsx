    ...
    <section className="builder-layout">
      ...
      {isEditMode && existingResponseCount > 0 && (
        <div className="inline-note">
          ...
          영향을 줄 수 있습니다. 기존 문항을 삭제한 뒤 다시 만들면 새 문항으로 인식되어 과거
          응답과 분리될 수 있으며, 새 문항을 추가하면 이전 응답의 해당 항목은 빈칸으로 표시됩니다.
          분기, 설명, 오타 수정은 가능하지만 선택지 삭제, 문항 삭제, 필수 여부 변경, 분기 변경은
          진행 중인 응답 흐름과 집계 해석이 달라질 수 있어 신중히 진행해주세요. 저장한 수정사항은
          응답자 화면에 바로 반영됩니다.
        </div>
      )}
