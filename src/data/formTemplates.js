...
const [
  YEONGJUNG_NEEDS_GEN_INFANT,
  YEONGJUNG_NEEDS_GEN_CHILD,
  YEONGJUNG_NEEDS_GEN_TEEN,
  YEONGJUNG_NEEDS_GEN_YOUTH,
  YEONGJUNG_NEEDS_GEN_MIDDLE,
  YEONGJUNG_NEEDS_GEN_SENIOR,
] = YEONGJUNG_NEEDS_GENERATION_OPTIONS;

const needsGenerationVisibility = (generationLabel) => ({
  visibilityConditions: [
    {
      id: `needs-q45-visible-${generationLabel}`,
      questionId: 'needs-q45',
      operator: CONDITION_OPERATORS.INCLUDES,
...
export const FORM_TEMPLATES = [
  ...
  },
  {
    ...
    preview:
      '연령대 quota, 조건분기, 생애주기별 욕구 문항을 포함한 2026 영중 지역주민 욕구조사 전용 템플릿입니다.',
    category: '욕구 조사',
    ...
    questions: [
      ...
      createNeedsQuestion(29, '[Q28=예] 참여하고 있다면 어떤 모임입니까? 해당 모두 선택', {
        type: QUESTION_TYPES.MULTIPLE_CHOICE,
        options: ['취미·여가(운동 제외)', '자기개발', '종교', '봉사', '지역문제 해결', '자녀 관련', '건강·운동', '친목모임', '복지관 프로그램 모임', '기타'],
        allowOther: true,
        required: true,
        sectionKey: 'community_participation',
      }),
      ...
      createNeedsQuestion(32, '향후 1년 내 주민모임·지역행사·공동체 활동에 참여할 의향이 있습니까?', {
        type: QUESTION_TYPES.SINGLE_CHOICE,
        options: YEONGJUNG_NEEDS_WILLINGNESS_OPTIONS,
        required: true,
        sectionKey: 'community_participation',
      ...
      createNeedsQuestion(38, '복지관 프로그램은 나에게 긍정적인 도움을 주고 있습니까?', {
        type: QUESTION_TYPES.SINGLE_CHOICE,
        options: YEONGJUNG_NEEDS_5_POINT_OPTIONS,
        required: true,
        sectionKey: 'welfare_center',
      ...
      createNeedsQuestion(41, '복지관이 가장 중요하게 해야 할 역할은 무엇입니까? 2개까지 선택', {
        type: QUESTION_TYPES.MULTIPLE_CHOICE,
        options: ['상담·사례관리', '경제·물질지원', '주민모임·관계망', '교육문화', '공간개방', '돌봄·건강', '취약계층 발굴', '주민참여·공동체 활동', '기타'],
        allowOther: true,
        required: true,
      ...
      createNeedsQuestion(45, '귀하와 같이 거주하고 있는 세대원은 누구입니까? (본인 포함, 해당 모두 선택)', {
        type: QUESTION_TYPES.MULTIPLE_CHOICE,
        options: YEONGJUNG_NEEDS_GENERATION_OPTIONS,
        required: true,
        sectionKey: 'lifecycle_needs',
      }),
      createNeedsQuestion('46-1', '[영유아] 현재 또는 향후 1~2년 안에 필요한 서비스 또는 지원은 무엇입니까? 2개까지 선택', {
        ...
        validation: { maxSelections: 2 },
        sectionKey: 'lifecycle_needs',
        ...needsGenerationVisibility(YEONGJUNG_NEEDS_GEN_INFANT),
      }),
      createNeedsQuestion('46-2', '[아동] 현재 또는 향후 1~2년 안에 필요한 서비스 또는 지원은 무엇입니까? 2개까지 선택', {
        description: YEONGJUNG_NEEDS_Q46_DESCRIPTION,
        type: QUESTION_TYPES.MULTIPLE_CHOICE,
        ...
        validation: { maxSelections: 2 },
        sectionKey: 'lifecycle_needs',
        ...needsGenerationVisibility(YEONGJUNG_NEEDS_GEN_CHILD),
      }),
      createNeedsQuestion('46-3', '[청소년] 현재 또는 향후 1~2년 안에 필요한 서비스 또는 지원은 무엇입니까? 2개까지 선택', {
        description: YEONGJUNG_NEEDS_Q46_DESCRIPTION,
        type: QUESTION_TYPES.MULTIPLE_CHOICE,
        ...
        validation: { maxSelections: 2 },
        sectionKey: 'lifecycle_needs',
        ...needsGenerationVisibility(YEONGJUNG_NEEDS_GEN_TEEN),
      }),
      createNeedsQuestion('46-4', '[청년] 현재 또는 향후 1~2년 안에 필요한 서비스 또는 지원은 무엇입니까? 2개까지 선택', {
        description: YEONGJUNG_NEEDS_Q46_DESCRIPTION,
        type: QUESTION_TYPES.MULTIPLE_CHOICE,
        ...
        validation: { maxSelections: 2 },
        sectionKey: 'lifecycle_needs',
        ...needsGenerationVisibility(YEONGJUNG_NEEDS_GEN_YOUTH),
      }),
      createNeedsQuestion('46-5', '[중장년] 현재 또는 향후 1~2년 안에 필요한 서비스 또는 지원은 무엇입니까? 2개까지 선택', {
        description: YEONGJUNG_NEEDS_Q46_DESCRIPTION,
        type: QUESTION_TYPES.MULTIPLE_CHOICE,
        ...
        validation: { maxSelections: 2 },
        sectionKey: 'lifecycle_needs',
        ...needsGenerationVisibility(YEONGJUNG_NEEDS_GEN_MIDDLE),
      }),
      createNeedsQuestion('46-6-birthyear', '[노년] 함께 살고 있는 노년 가족의 출생연도를 작성해주세요 (본인 제외, 1명만 작성)', {
        type: QUESTION_TYPES.NUMBER,
        placeholder: '예: 1955',
        validation: { min: 1900, max: 2026 },
        required: false,
      ...
      createNeedsQuestion(47, '복지관 이용 시, 선호하는 요일과 시간대는 언제입니까?', {
      ...
      createNeedsQuestion(48, '우리 동네에서 가장 불편하거나 개선이 필요한 점은 무엇입니까? 2개까지 선택', {
        type: QUESTION_TYPES.MULTIPLE_CHOICE,
        options: ['거리·교통', '주거환경', '안전·치안', '생활정보 부족', '이웃관계 부족', '아이·청소년 공간 부족', '어르신 돌봄 부족', '문화·여가 부족', '기타'],
        allowOther: true,
        required: true,
        validation: { maxSelections: 2 },
        sectionKey: 'lifecycle_needs',
      }),
      createNeedsQuestion(49, '영등포 지역 또는 우리 동네가 더 살기 좋은 마을이 되기 위해 가장 필요하다고 생각하는 것은 무엇입니까?', {
        type: QUESTION_TYPES.LONG_TEXT,
        sectionKey: 'lifecycle_needs',
      }),
      createNeedsQuestion(50, '복지관에서 새롭게 운영되었으면 하는 프로그램이나 공간이 있다면 무엇입니까?', {
        type: QUESTION_TYPES.LONG_TEXT,
        sectionKey: 'lifecycle_needs',
      }),
      createNeedsQuestion(51, '복지관이 주민과 함께 만들어가면 좋을 활동이나 모임은 무엇입니까?', {
        type: QUESTION_TYPES.LONG_TEXT,
        sectionKey: 'lifecycle_needs',
      }),
      createNeedsQuestion(52, '영중종합사회복지관에 바라는 점은 무엇입니까?', {
        type: QUESTION_TYPES.LONG_TEXT,
        sectionKey: 'lifecycle_needs',
      }),
